...
export const metadata: Metadata = {
  title: {
    default: "Pathfinder — Your Reentry Route",
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html:
              "(function(){try{var t=localStorage.getItem('pf-theme');if(t==='light'||t==='dark')document.documentElement.setAttribute('data-theme',t)}catch(e){}})()",
          }}
        />
      </head>
